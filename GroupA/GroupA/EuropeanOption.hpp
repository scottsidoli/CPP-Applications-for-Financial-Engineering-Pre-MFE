...
// EuropeanOption.hpp
//
// File contains the European Option class. It includes the necessary parameters to price
// European options using Black-Scholes. Here we have getter and setter functions. We also
// have the option sensitivities aka, the greeks. Call price and put price are also here.
// We have set option function that takes any of the defined types and it knows what value
// to change. We also have a function that produces a vector of prices given a vector of
// parameter values.
