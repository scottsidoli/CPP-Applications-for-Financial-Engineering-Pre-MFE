...
namespace ssidoli
{
	namespace CAD
	{
		...
		Line::Line() : starting_point(), ending_point()
		{
			//cout << "Default Line Constructor!" << endl;			// We initialize a line to have the starting point
		...
		Line::Line(const Point& A, const Point& B): starting_point(A), ending_point(B)			// Constructor creates a line from initialized input.
		{
			//cout << "Line Constructor with set points" << endl;
		}
