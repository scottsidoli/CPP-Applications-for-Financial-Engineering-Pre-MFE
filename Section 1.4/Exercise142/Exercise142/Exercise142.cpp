// Exercise 1.4.2 - Word Counter (Do-While Loop)
//
// by Scott Sidoli
//
// 3-26-19
...
// and returns the count of characters, words, and lines. We use a do-while loop.
...
int main()
{
	...
	while (c != 4);											// The sub-statement is executed as long as it is not EOF. Once ctrl+d
															// is pressed, the program exits the loop.
